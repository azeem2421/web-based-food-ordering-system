<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="food_ordering_system.Admin.Product" %>
                     ...
                     <div class="col-sm-12">
                         <div class="card">
                             ...
                             <div class="card-block">
                                 <div class="row">
                                     <div class="col-sm-6 col-md-4 col-mg-4 ">
                                               ...
                                               <div class="form-group">
                                                 ...
                                                 <div>
                                                     ...
                                                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                         ErrorMessage="Quantity should not be negative" ForeColor="Red" Display="Dynamic"
                                             ...
                                             <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                 ...
                                                 <div>
                                                     ...
                                                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FOODDBConnectionString %>" 
                                                         ProviderName="<%$ ConnectionStrings:FOODDBConnectionString.ProviderName %>" 
                                     ...
                                     <div class="col-sm-6 col-md-8 col-mg-8 mobile-inputs ">
                                         ...
                                         <div class="card-block table-border-style">
                                             <div class="table-responsive">
                                                 ...
                                                 <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand" OnItemDataBound="rProduct_ItemDataBound" >
                                                     ...
                                                     <ItemTemplate>
                                                         <tr>
                                                             <td class="table-pluds"><%# Eval("Name") %></td>
                                                             ...
                                                             <td>
                                                                 ...
                                                                 <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete" CssClass="badge bg-danger" CausesValidation="false"
